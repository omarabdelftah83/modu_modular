...
class ErrorMasage extends Equatable{
  ...
  const ErrorMasage({required this.stutesCode,required this.success,required this.stutesMassage});
  factory ErrorMasage.fromJson(Map<String,dynamic>json){
    return ErrorMasage(stutesCode: json ['stutesCode'], success:json ['success'], stutesMassage:json ['stutesMassage)']);
  }
